...
print(vid.captions.get_captions_by_name('English').txt())
print(vid.captions.get_captions_by_lang_code('en_auto'))
print(vid.captions.get_captions_by_lang_code('en_auto').txt())
print(vid.captions.get_translated_captions_by_name('Basque'))
print(vid.captions.get_translated_captions_by_name('Basque').txt())
print(vid.captions.get_translated_captions_by_lang_code('fr'))
print(vid.captions.get_translated_captions_by_lang_code('fr').txt())
